...
Mooncakes publication is not part of this repository closeout pass. The package archive is locally validated with `moon package`; a future publication can use the same module name, `python123/moondepsolve`.
