...
SECTIONS = [
    ...
    (
        "赛事进度与交付",
        "官方开发期为 2026-04-29 至 2026-07-12，验收期为 2026-07-13 至 2026-07-17。4 月 29 日后完成 v0.1 求解基础、v0.2 图与冲突解释、v0.3 精确升级规划和文件 CLI。终验交付双仓库一致历史、v0.3.0 标签/Release、Mooncakes 包 python123/moondepsolve@0.3.0 与 fresh clone 复验。",
    ),
]
